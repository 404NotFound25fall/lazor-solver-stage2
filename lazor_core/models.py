...
class Block:
    ...
    def interact(self, direction: Tuple[int, int]) -> List[Tuple[int, int]]:
        ...
        - OPAQUE: absorbs laser (no outgoing directions).
        - REFLECT: reflects laser like a mirror - reverses the non-zero component.
        - REFRACT: splits laser - transmits straight through AND reflects (two beams).
